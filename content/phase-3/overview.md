...
```mermaid
flowchart LR
  G[Grammar<br/>Technical register] --> V[Vocabulary<br/>IT systems]
  V --> S[Speaking<br/>Explain architecture]
  S --> L[Listening<br/>Dev podcasts]
  L --> R[Reading<br/>Docs and heise]
  R --> W[Writing<br/>README ticket ADR]
```

...
```mermaid
flowchart LR
  A[Stand in drei Zeilen<br/>fertig laufend offen] --> B[Problem benennen<br/>nach heutigem Stand]
  B --> C[Zahl nennen<br/>realistisch nicht optimistisch]
  C --> D[Zwei Optionen<br/>mit Konsequenz je Option]
  D --> E[Bedingt zusagen<br/>unter der Voraussetzung dass]
```

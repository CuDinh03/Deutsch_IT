...
```mermaid
flowchart LR
  A[Ziel nennen<br/>Richtung Senior] --> B[Leistung belegen<br/>Zahlen statt Adjektive]
  B --> C[Luecke erfragen<br/>Was fehlt noch]
  C --> D[Kriterien vereinbaren<br/>Woran messbar]
  D --> E[Schriftlich festhalten<br/>selbst schicken]
```

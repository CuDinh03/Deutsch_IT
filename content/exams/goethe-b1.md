...
```mermaid
flowchart LR
  A[Phase-1-Test<br/>Woche 8] --> B{Brauchst du<br/>das Papier?}
  B -->|Nein| C[Weiter zu Phase 2<br/>Ziel telc B2 W20]
  B -->|Ja| D{Test >= 70?}
  D -->|Ja| E[B1 buchen<br/>2-3 Wochen Format ueben]
  D -->|Nein| F[Schwachstelle schliessen<br/>dann buchen]
```

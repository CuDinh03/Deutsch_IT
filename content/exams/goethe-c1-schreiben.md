...
```mermaid
flowchart TD
  A[Einleitung<br/>Thema und These] --> B[Gegenposition<br/>fair referiert]
  B --> C[Entkraeftung<br/>zwar aber]
  C --> D[Eigene Argumente<br/>zwei, mit Beispiel]
  D --> E[Schluss<br/>Position und Ausblick]
```

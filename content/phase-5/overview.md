...
```mermaid
flowchart TD
  A[Stellenanzeige lesen] --> B[Bewerbung<br/>Lebenslauf + Anschreiben]
  B --> C[HR-Screening<br/>Telefon oder Video]
  C --> D[Fachgespraech<br/>Technical Round]
  D --> E[Angebot + Gehaltsverhandlung]
  E --> F[Vertrag + Probezeit]
```

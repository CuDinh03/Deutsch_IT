...
```mermaid
flowchart LR
  A[Vorhersagen<br/>Frage antizipieren] --> B[Schluesselwoerter<br/>Gehalt Team Termin]
  B --> C[Notizen<br/>Stichworte mitschreiben]
  C --> D[Bestaetigen<br/>hoeflich rueckfragen]
```

...
```mermaid
flowchart TD
  A[Stellenanzeige] --> B[Bewerbung eingereicht]
  B --> C[Eingangsbestaetigung]
  C --> D[Screening-Call<br/>HR 20 bis 30 Minuten]
  D --> E[Fachgespraech<br/>Team 60 bis 90 Minuten]
  E --> F{Weitere Runde?}
  F -->|oft| G[Case Probearbeiten<br/>oder Gespraech mit Fuehrung]
  F -->|manchmal| H[Angebot]
  G --> H
  H --> I[Vertrag pruefen<br/>und unterschreiben]
```
